...
python /root/src/mapnik-stylesheets-polar/render-polar-tiles-${SRS}.py --style=/root/src/mapnik-stylesheets-polar/${STYLESHEET}-${SRS}.xml --dir=${MAPNIK_TILE_DIR} --minzoom=${MIN_ZOOM} --maxzoom=${MAX_ZOOM}
